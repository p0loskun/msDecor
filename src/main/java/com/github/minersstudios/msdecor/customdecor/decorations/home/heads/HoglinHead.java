...
public class HoglinHead implements CustomDecorData {
	...
	public HoglinHead() {
		this.namespacedKey = new NamespacedKey(Main.getInstance(), "hoglin_head");
		this.itemStack = new ItemStack(Material.LEATHER_HORSE_ARMOR);
		ItemMeta itemMeta = this.itemStack.getItemMeta();
		itemMeta.setCustomModelData(1162);
		itemMeta.displayName(ChatUtils.createDefaultStyledName("Голова борова"));
