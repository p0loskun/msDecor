...
public class OakNightstand implements Wrenchable {
	...
	public OakNightstand() {
		this.namespacedKey = new NamespacedKey(MSDecor.getInstance(), "oak_nightstand");
	...
	public enum Type implements Typed.Type {
		...
		Type(int customModelData) {
			this.namespacedKey = new NamespacedKey(MSDecor.getInstance(), this.name().toLowerCase(Locale.ROOT) + "_oak_nightstand");
