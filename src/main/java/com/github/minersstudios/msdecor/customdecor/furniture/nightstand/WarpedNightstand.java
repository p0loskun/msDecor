...
public class WarpedNightstand implements Wrenchable {
	...
	public WarpedNightstand() {
		this.namespacedKey = new NamespacedKey(Main.getInstance(), "warped_nightstand");
	...
	public enum Type implements Typed.Type {
		...
		Type(int customModelData) {
			this.namespacedKey = new NamespacedKey(Main.getInstance(), this.name().toLowerCase(Locale.ROOT) + "_warped_nightstand");
