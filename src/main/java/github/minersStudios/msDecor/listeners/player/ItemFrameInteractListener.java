...
public class ItemFrameInteractListener implements Listener {
    ...
    public void onHangingBreak(HangingBreakEvent event) {
        ...
        CustomDecor customDecor = new CustomDecor(event.getEntity().getLocation().getBlock(), null);
    ...
    public void onEntityDamageByEntity(@Nonnull EntityDamageByEntityEvent event) {
        ...
        event.setCancelled(true);
        if(event.getDamager() instanceof Player && ((Player) event.getDamager()).getGameMode() == GameMode.ADVENTURE) return;
